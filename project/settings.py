...
MINIO_STORAGE_ACCESS_KEY = AWS_S3_ACCESS_KEY_ID
MINIO_STORAGE_SECRET_KEY = AWS_S3_SECRET_ACCESS_KEY
...
MINIO_STORAGE_DATASETS_BUCKET_NAME = config("MINIO_STORAGE_DATASETS_BUCKET_NAME")
MINIO_DATASET_DOWNLOAD_CHUNK_SIZE = config("MINIO_DATASET_DOWNLOAD_CHUNK_SIZE", cast=int, default=8388608)
MINIO_DATASET_SHA512SUMS_FILENAME = config("MINIO_DATASET_SHA512SUMS_FILENAME", default="SHA512SUMS")
MINIO_DATASET_TABLES_FILES_LIST_FILENAME = config("MINIO_DATASET_TABLES_FILES_LIST_FILENAME", default="_meta/list.html")
