...
export const electionGallery = {
  ...
  setup(props) {
    ...
    const search = Vue.ref(filters.q)
  ...
  template: `
    ...
    <div class="my-5">
          ...
          <n-gi>
            <n-card hoverable style="margin: auto;">
              <div class="text-center" style="transform: rotate(0);">
                ...
                <div>
                  <span class="badge rounded-pill text-bg-dark fw-normal">indeferido</span>
                </div>
      ...
      <n-space class="pt-4 mx-auto d-flex justify-content-center">
        <n-pagination
